package io.github.alathra.alathranwars.database.handler;
...
import io.github.alathra.alathranwars.database.config.HikariConfigFactory;
import io.github.alathra.alathranwars.database.exception.DatabaseInitializationException;
import io.github.alathra.alathranwars.database.exception.DatabaseMigrationException;
import io.github.alathra.alathranwars.database.jooq.JooqContext;
import io.github.alathra.alathranwars.database.migration.FlywayManager;
...
public final class DatabaseHandler extends AbstractService implements Reloadable {
    ...
    public void onLoad(AbstractAlathranWars plugin) {
        if (config == null)
            config = DatabaseConfig.fromConfig(plugin.getConfigHandler().getDatabaseConfig(), plugin.getDataPath());
