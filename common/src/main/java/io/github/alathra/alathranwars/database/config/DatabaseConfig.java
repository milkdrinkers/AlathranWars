package io.github.alathra.alathranwars.database.config;
...
public class DatabaseConfig {
     ...
     */
    public static DatabaseConfig fromConfig(io.github.alathra.alathranwars.config.DatabaseConfig cfg, Path databasePath) {
        return builder()
