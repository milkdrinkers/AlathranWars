package io.github.alathra.alathranwars.hook.bstats;
...
public class BStatsHook extends AbstractHook {
    private final static int BSTATS_ID = 23308; // Signup to BStats and register your new plugin here: https://bstats.org/getting-started, replace the id with you new one!
